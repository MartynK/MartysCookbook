...
\usepackage{multicol} \usepackage{float} \usepackage{afterpage} \usepackage{inputenc} \DeclareUnicodeCharacter{0081}{ } \DeclareUnicodeCharacter{03B2}{\ensuremath{\beta}} \DeclareUnicodeCharacter{03C1}{\ensuremath{\rho}} \DeclareUnicodeCharacter{03C3}{\ensuremath{\sigma}} \DeclareUnicodeCharacter{03C4}{\ensuremath{\tau}}
\usepackage{booktabs}
...
\multicolumn{1}{m{0.1\textwidth}!{\huxvb{0, 0, 0}{0.8}}}{\cellcolor[RGB]{242, 242, 242}\hspace{6pt}\parbox[c]{0.1\textwidth-6pt-6pt}{\huxtpad{6pt + 1em}\centering {\fontsize{7pt}{8.4pt}\selectfont 7.0 (3.3, 12.0)}\huxbpad{6pt}}} &
\multicolumn{1}{m{0.1\textwidth}!{\huxvb{0, 0, 0}{0.8}}}{\cellcolor[RGB]{242, 242, 242}\hspace{6pt}\parbox[c]{0.1\textwidth-6pt-6pt}{\huxtpad{6pt + 1em}\centering {\fontsize{7pt}{8.4pt}\selectfont 11.5 (6.0, 15.8)}\huxbpad{6pt}}} &
\multicolumn{1}{m{0.1\textwidth}!{\huxvb{0, 0, 0}{0.8}}}{\cellcolor[RGB]{242, 242, 242}\hspace{6pt}\parbox[c]{0.1\textwidth-6pt-6pt}{\huxtpad{6pt + 1em}\centering {\fontsize{7pt}{8.4pt}\selectfont 8.5 (4.0, 15.0)}\huxbpad{6pt}}} \tabularnewline[-0.5pt]
...
\FunctionTok{source}\NormalTok{(here}\SpecialCharTok{::}\FunctionTok{here}\NormalTok{(}\StringTok{"inst"}\NormalTok{,}\StringTok{"functions"}\NormalTok{, }\StringTok{"wrangling.r"}\NormalTok{))}
...
\FunctionTok{save.image}\NormalTok{(}\AttributeTok{file =}\NormalTok{ here}\SpecialCharTok{::}\FunctionTok{here}\NormalTok{(}\StringTok{"inst"}\NormalTok{,}\StringTok{"extdata"}\NormalTok{,}\StringTok{"cookbook\_out.Rdata"}\NormalTok{))}
