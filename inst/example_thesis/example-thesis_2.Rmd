...
subtitle: |
  | An exploration of the balance between form and function in documentation, with a special focus on factor management in R and stakeholder-friendly data presentation.
  | <br><br>
author: 
  name: "Márton Kiss MD"
committee:
...
Factors sometimes get on my nerve. Their levels' order keeps changing, you want to switch between human readable (stakeholder readable) and easy-to-type names, etc.
