...
load( file = here::here("states", "before_chap1.Rdata"))
...
#| fig.show='hide', 
#| fig.path=paste0(graphics_output_path, "mandatory_chunk_name"),
#| results='hide', 
#| collapse=T
...
sjPlot::tab_model(mod,
    ...
    , file = here::here("stuff","temp.html") # have to export temporarily
  )
...
invisible({
  ...
  webshot2::webshot(url=here::here("stuff","temp.html"), 
                    cliprect = c(0,0,400,400),
                    file = here::here("figures","webshot.png"))
})
