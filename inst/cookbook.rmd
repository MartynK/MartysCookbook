...
source(here::here("functions","load_stuff.r"))
source(here::here("functions", "wrangling.r"))
...
knitr::opts_chunk$set(
    ...
    dev = 'tiff',                            # PNG legyen az alapértelmezett képformátum
    compression = 'lzw',
...
graphics_path <- "../figures/"            # a máshonnan származó ábrák elérési útja
...
\graphicspath{ {../figures} {../rmds/cookbook_files/figure-latex/} {../figure-latex/} {../rmds/01_chap1_files/figure-latex/}}
...
```{r}
save.image( file = here::here("states", "before_chap1.Rdata"))
```

```{r child = here::here("rmds", "01_chap1.rmd")}

```


`r save.image( file = here::here("states", "before_chap2.Rdata"))`
...
for (i in 1:length(valtozok)) {
  ...
  out <- c(out,
           knitr::knit_child(here::here('rmds','cyclic_chap2.Rmd'),
                             quiet = T))
}
...
```{r}
tools::md5sum(here::here("data","Iris.xls"))
```
...
Sys.time()
save.image(file = here::here("cookbook_out.Rdata"))
