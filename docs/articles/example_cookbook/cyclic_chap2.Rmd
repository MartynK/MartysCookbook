...
\begin{multicols}{2}
\begin{figure}[H]
\includegraphics[width = \linewidth]{`r paste0(fig_directory, params$figname_prefix, '-fig1-1')`}
...
\begin{figure}[H]
\includegraphics[width = \linewidth]{`r paste0(fig_directory, params$figname_prefix, '-fig1-2')`}
\centering
